...
echo ""
echo "=== THEORY ==="
echo "pip's build isolation (PEP 517) creates its own prefix in /tmp"
echo "regardless of TMPDIR. The --prefix flag is set internally by pip."
echo "Solutions:"
echo "1. Use --no-build-isolation to skip this entirely"
echo "2. Mount a larger /tmp"
echo "3. Set PIP_BUILD_DIR or use pip's --build option (deprecated)"
